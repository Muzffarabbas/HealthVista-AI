...
import { parseHealthInput, generateDailySummary } from './services/geminiService';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] pb-24">
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === 'chat' && (
            <motion.div 
              ...
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -20 }}
              className="bg-white rounded-[32px] shadow-sm overflow-hidden flex flex-col h-[70vh]"
            >
              ...
              <form onSubmit={handleSendMessage} className="p-4 bg-gray-50 border-t border-gray-100">
                <div className="relative">
                  <input 
                    ...
                    className="w-full bg-white border border-gray-200 rounded-2xl py-4 pl-6 pr-14 focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all shadow-sm"
                  />
                  <button 
                    type="submit"
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <select name="gender" defaultValue={profile?.gender} className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500/20" required>
                  ...
                  <div className="space-y-2">
                    ...
                    <select name="goal" defaultValue={profile?.goal} className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-emerald-500/20" required>
      ...
      {/* Navigation Bar */}
      <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 bg-white/80 backdrop-blur-xl border border-white/20 shadow-2xl rounded-3xl p-2 flex items-center gap-2 z-50">
        <NavButton 
